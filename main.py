...
TEMPLATES = {
    ...
    "lkoach_kayam_hatzaa": "היי {name},\nבהמשך לשיחתנו, הינכם לקוחות קיימים של yes.\nהשירות מתבצע מול השירות לקוחות שלנו שלוחה 1 או 3, תודה ויום טוב :)",
    ...
    "mivtza_charig": "היי {name},\n\nyes+ ב־179 ₪ בלבד לחודש למשך שנה!\nכולל אינטרנט סיבים בזק 1000 מגה + ראוטר\n\nבנוסף מקבלים:\n• עד 7 ממירים חדשים בחינם\n• 3 חודשים חינם של צ'רלטון, Disney+ ו־HBO\n\nהכי זול וטוב שיצא ל-yes+ על המסלול הזה.\n\nאם זה רלוונטי לך, אפשר לחזור אליך ולסגור מהר לפני שייגמר.",
    
    "lkoach_chadash": "היי {name}, מדבר רובי מהמכירות של yes.\nקיבלתי עכשיו את הפרטים שלך, וככה לפני השיחה שלנו רציתי לוודא פרט קצר:\nהאם כיום אתה לקוח של yes או Sting+?",    
}
